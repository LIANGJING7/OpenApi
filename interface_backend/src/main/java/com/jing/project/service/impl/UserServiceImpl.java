...
import static com.jing.project.constant.UserConstant.ADMIN_ROLE;
import static com.jing.project.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            ...
            String accessKey = md5.digestHex(SALT + userAccount + RandomUtil.randomNumbers(5));
            String secretKey = md5.digestHex(SALT + userPassword +RandomUtil.randomNumbers(8));
            // 3. 插入数据
            User user = new User();
    ...
    public User getLoginUser(HttpServletRequest request) {
        System.out.println("管理页面请求" +session);
        if(session == null){
